  ...
  final List<Map<String, dynamic>> categories = [
    {
      ...
      'route': const UserTopExpertsScreen(),
    },
    {
      'label': 'Home',
      'image': 'assets/images/home.jpg',
      'route': const UserHomeExpertsScreen(),
    },
    {
      'label': 'Career and Business',
      'image': 'assets/images/career.jpg',
      'route': const UserCareerExpertsScreen(),
    },
    {
      'label': 'Fashion & Beauty',
      'image': 'assets/images/fashion.jpg',
      'route': const UserFashionBeautyExpertsScreen(),
    },
    {
      'label': 'Wellness',
      'image': 'assets/images/wellness.jpg',
      'route': const UserWellnessExpertsScreen(),
    },
  ];
      ...
      if (response.statusCode == 200) {
        ...
        final approvedExperts =
            fetchedExperts
                ...
                .map<shared.ExpertModel>(
                  (json) => shared.ExpertModel.fromJson(json),
                )
                .toList();
                  ...
                  Expanded(
                    child: LayoutBuilder(
                      builder: (context, constraints) {
                        ...
                        double aspectRatio =
                            constraints.maxWidth < 350 ? 1.2 : 0.75;
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: screenWidth < 350 ? 4 : 6),
                      // Description
                      Text(
