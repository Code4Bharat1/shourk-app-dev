  ...
  Future<void> fetchWalletBalance() async {
    try {
      ...
      final response = await http.get(
        Uri.parse('http://10.0.2.2:5070/api/expertwallet/balances'),
        headers: {
  ...
  Future<void> fetchExpert() async {
    try {
      final res = await http.get(
        Uri.parse('http://10.0.2.2:5070/api/expertauth/${widget.expertId}'),
  ...
  Future<void> _handleBooking() async {
    ...
    try {
      ...
      final sessionResponse = await http.post(
        Uri.parse('http://10.0.2.2:5070/api/session/experttoexpertsession'),
        headers: {
          'Authorization': 'Bearer $authToken',
          'Content-Type': 'application/json',
        },
      ...
      if (!isFirstSession && finalPriceAfterGiftCard > 0) {
        final paymentResponse = await http.post(
          Uri.parse('http://10.0.2.2:5070/api/expertwallet/spending/pay'),
          headers: {
            'Authorization': 'Bearer $authToken',
            'Content-Type': 'application/json',
          },
